...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="about-info">
                                <h4>Patient Profile <span><a href="javascript:;"><i
                                                class="feather-more-vertical"></i></a></span></h4>
                            </div>
                            <div class="Patient-profile-head">
                                <div class="profile-bg-img">
                                    <img src="{{asset('dashboard/assets/img/profile-bg.jpg')}}" alt="Profile">
                                </div>
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                        <div class="profile-user-box">
                                            <div class="profile-user-img">
                                                <img src="{{asset('dashboard/assets/img/profile-user.jpg')}}" alt="Profile">
                                                <div class="form-group doctor-up-files profile-edit-icon mb-0">
                                                    <div class="uplod d-flex">
                                                        <label class="file-upload profile-upbtn mb-0">
                                                            <img src="{{asset('dashboard/assets/img/icons/camera-icon.svg')}}"
                                            ...
                                            <div class="names-profiles">
                                                ...
                                                <h5>Senior Patient</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 d-flex align-items-center">
                                        <div class="follow-group">
                                            <div class="Patient-follows">
                                                <h5>Followers</h5>
                                                <h4>850</h4>
                                            </div>
                                            <div class="Patient-follows">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="Patient-personals-grp">
                        <div class="card">
                            <div class="card-body">
                                <div class="heading-detail ">
                                    <h4 class="mb-3">About me</h4>
                                    <p>Hello I am Dr. Bruce Willis a Gynaecologist in Sanjivni Hospital Surat. I
                                        love to work with all my hospital staff and seniour Patients.</p>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="personal-activity">
                                    <div class="personal-icons status-grey">
                                        <img src="{{asset('dashboard/assets/img/icons/medal-01.svg')}}" alt="">
                                    </div>
                                ...
                                <div class="personal-activity">
                                    <div class="personal-icons status-green">
                                        <img src="{{asset('dashboard/assets/img/icons/medal-02.svg')}}" alt="">
                                    </div>
                                    <div class="views-personal">
                                        <h4>Certified</h4>
                                ...
                                <div class="personal-activity mb-0">
                                    <div class="personal-icons status-orange">
                                        <img src="{{asset('dashboard/assets/img/icons/medal-03.svg')}}" alt="">
                                    </div>
                                    <div class="views-personal">
                                        ...
                                        <li>
                                            <a href="Patient-profile.html" class="active"><span
                                                    class="set-about-icon me-2"><img
                                                        src="{{asset('dashboard/assets/img/icons/menu-icon-02.svg')}}" alt=""></span>About
                                                me</a>
                                        </li>
                                        <li>
                                            <a href="Patient-setting.html"><span class="set-about-icon me-2"><img
                                                        src="{{asset('dashboard/assets/img/icons/menu-icon-16.svg')}}" alt=""></span>Settings</a>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div class="detail-personal">
                                                ...
                                                <h3><a href="../cdn-cgi/l/email-protection.html"
                                                       class="__cf_email__"
                                                       data-cfemail="27455552444267424a464e4b0944484a">[email&#160;protected]</a>
                                                </h3>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-6">
