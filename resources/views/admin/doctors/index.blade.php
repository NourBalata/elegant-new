...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
                                ...
                                <td class="text-end">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{route('doctors.edit',$info->id)}}"><i
                                                    class="fa-solid fa-pen-to-square m-r-5"></i> Edit</a>
                                            <a class="dropdown-item" data-user_id ="{{$info->id}}" href="#" data-bs-toggle="modal" data-bs-target="#delete_doctor" ><i
            ...
            <div class="modal custom-modal modal-bg fade" id="delete_doctor" role="dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="modal-btn delete-action">
                                <div class="row">
                                    <div class="col-6">
                                        <form action="{{route('doctors.destroy','delete')}}" method="post" >
                                            @csrf
                                            @method('DELETE')
