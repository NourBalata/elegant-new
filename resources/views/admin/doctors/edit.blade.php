...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('doctors.update',$data->id)}}" autocomplete="off" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-12">
...
{{--                                    <div class="form-check-inline">--}}
{{--                                        <label class="form-check-label">--}}
{{--                                            <input type="radio"  name="balance_commission"  value="balance" class="form-check-input " {{$data->balance && $data->commission  >0 ? 'checked' :''}}>Balance--}}
{{--                                        </label>--}}
{{--                                    </div>--}}
{{--                                    <div class="form-check-inline">--}}
{{--                                        <label class="form-check-label">--}}
