                    ...
                    <div class="table-responsive">
                        <table id="table1"  class="table border-0 custom-table comman-table  mb-0">
                            ...
                            <tr>
                                ...
                                <td class="profile-image"><a href="{{route('suppliers.show',$info->id)}}"><img width="28" height="28"
                                ...
                                <td> <span class="custom-badge status-green"> {{$info->balance}}</span></td>
                                ...
                                <td class="text-end">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{route('suppliers.edit',$info->id)}}"><i
