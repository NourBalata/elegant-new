                            ...
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                       data-bs-target="#edit_brand" data-brand_id="{{$info->id}}"
                                       data-image="{{$info->image}}"
                                       data-status="{{$info->status}}" data-name="{{$info->name}}"><i
                                            class="fa-solid fa-pen-to-square m-r-5"></i> Edit</a>
                                    <a class="dropdown-item" data-brand_id="{{$info->id}}" href="#"
                                       data-bs-toggle="modal" data-bs-target="#delete_brand"><i
...
{{--    //add_category--}}
<div class="modal custom-modal fade invoices-preview" id="add_brand" role="dialog">
<div class="modal-dialog modal-dialog-centered">
<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="add_category">New Brand</h5>
...
{{--    //edit_category--}}
<div class="modal custom-modal fade invoices-preview" id="edit_brand" role="dialog">
<div class="modal-dialog modal-dialog-centered">
ئذ<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="add_category">Edit Brand</h5>
        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true"> &times;</span>
        </button>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card invoice-info-card">
                    <div class="card-body pb-0">
                        <div class="modal-body">
                            <form action="{{route('brands.update','edit')}}" method="post"
                                  enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <input type="hidden" id="id" value="" name="brand_id">
...
{{--    delete_patient--}}
<div class="modal custom-modal modal-bg fade" id="delete_brand" role="dialog">
<div class="modal-dialog modal-dialog-centered">
<div class="modal-content">
    <div class="modal-body">
