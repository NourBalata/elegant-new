...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
                    ...
                    <div class="table-responsive">
                        <table id="table1"  class="table border-0 custom-table comman-table  mb-0">
                            ...
                            <tr>
                                ...
                                <td class="profile-image"><a href="{{route('staff.show',$info->id)}}"><img width="28" height="28"
                                ...
                                <td class="text-end">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{route('staff.edit',$info->id)}}"><i
                                                    class="fa-solid fa-pen-to-square m-r-5"></i> Edit</a>
                                            <a class="dropdown-item" data-user_id ="{{$info->id}}" href="#" data-bs-toggle="modal" data-bs-target="#delete_staff" ><i
            ...
            <div class="modal custom-modal modal-bg fade" id="delete_staff" role="dialog">
...
@section('scripts')
    ...
    <script>
        // Model Delete
        $('#delete_staff').on('show.bs.modal', function(event) {
