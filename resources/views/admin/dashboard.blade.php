...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-6 position-blk">
                <div class="morning-img">
                    <img src="{{asset('dashboard/assets/img/morning-img-01.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="dash-widget">
                <div class="dash-boxs comman-flex-center">
                    <img src="{{asset('dashboard/assets/img/icons/calendar.svg')}}" alt="">
                </div>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="dash-widget">
                <div class="dash-boxs comman-flex-center">
                    <img src="{{asset('dashboard/assets/img/icons/profile-add.svg')}}" alt="">
                </div>
                <div class="dash-content dash-count">
                    <h4>New Patients</h4>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="dash-widget">
                <div class="dash-boxs comman-flex-center">
                    <img src="{{asset('dashboard/assets/img/icons/scissor.svg')}}" alt="">
                </div>
                <div class="dash-content dash-count">
                    <h4>Operations</h4>
                    <h2><span class="counter-up">56</span></h2>
                    <p><span class="negative-view"><i class="feather-arrow-down-right me-1"></i>15%</span> vs
                        last month</p>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="dash-widget">
                <div class="dash-boxs comman-flex-center">
                    <img src="{{asset('dashboard/assets/img/icons/empty-wallet.svg')}}" alt="">
                </div>
                <div class="dash-content dash-count">
                    <h4>Earnings</h4>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="donut-chart-dash" class="chart-user-icon">
                        <img src="{{asset('dashboard/assets/img/icons/user-icon.svg')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="activity-top">
                        <div class="activity-boxs comman-flex-center">
                            <img src="{{asset('dashboard/assets/img/icons/dep-icon-01.svg')}}" alt="">
                        </div>
                    ...
                    <div class="activity-top">
                        <div class="activity-boxs comman-flex-center">
                            <img src="{{asset('dashboard/assets/img/icons/dep-icon-02.svg')}}" alt="">
                        </div>
                        <div class="departments-list">
                            <h4>Dentist</h4>
                            <p>24%</p>
                    ...
                    <div class="activity-top">
                        <div class="activity-boxs comman-flex-center">
                            <img src="{{asset('dashboard/assets/img/icons/dep-icon-03.svg')}}" alt="">
                        </div>
                        <div class="departments-list">
                            <h4>ENT</h4>
                            <p>10%</p>
                    ...
                    <div class="activity-top">
                        <div class="activity-boxs comman-flex-center">
                            <img src="{{asset('dashboard/assets/img/icons/dep-icon-04.svg')}}" alt="">
                        </div>
                        <div class="departments-list">
                            <h4>Cardiologist</h4>
                            <p>15%</p>
                    ...
                    <div class="activity-top mb-0">
                        <div class="activity-boxs comman-flex-center">
                            <img src="{{asset('dashboard/assets/img/icons/dep-icon-05.svg')}}" alt="">
                        </div>
                        <div class="departments-list">
                            <h4>Opthomology</h4>
                            <p>20%</p>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0 border-0 datatable custom-table">
                            ...
                            <tr>
                                ...
                                <td class="table-image appoint-doctor">
                                    <img width="28" height="28" class="rounded-circle"
                                         src="{{asset('dashboard/assets/img/profiles/avatar-02.jpg')}}" alt="">
                                    <h2>Dr.Jenny Smith</h2>
                                </td>
                                <td class="appoint-time"><span>12.05.2022 at </span>7.00 PM</td>
                                <td>
                                    <button class="custom-badge status-green ">Fracture</button>
                                </td>
                                <td class="text-end">
                            ...
                            <tr>
                                ...
                                <td class="table-image appoint-doctor">
                                    <img width="28" height="28" class="rounded-circle"
                                         src="{{asset('dashboard/assets/img/profiles/avatar-03.jpg')}}" alt="">
                                    <h2>Dr.Angelica Ramos</h2>
                                </td>
                                <td class="appoint-time"><span>13.05.2022 at </span>7.00 PM</td>
                                <td>
                                    <button class="custom-badge status-green">Fever</button>
                                </td>
                                <td class="text-end">
                                    <div class="dropdown dropdown-action">
                                        <a href="#" class="action-icon dropdown-toggle"
                            ...
                            <tr>
                                ...
                                <td class="table-image appoint-doctor">
                                    <img width="28" height="28" class="rounded-circle"
                                         src="{{asset('dashboard/assets/img/profiles/avatar-04.jpg')}}" alt="">
                                    <h2>Dr.Martin Doe</h2>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="table-image appoint-doctor">
                                    <img width="28" height="28" class="rounded-circle"
                                         src="{{asset('dashboard/assets/img/profiles/avatar-05.jpg')}}" alt="">
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <h4 class="card-title d-inline-block">Recent Patients </h4> <a href="patients.html"
                                                                                   class="float-end patient-views">show
                        all</a>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0 border-0 datatable custom-table">
                            ...
                            <tr>
                                ...
                                <td>Heart attack</td>
                                <td>
                                    <button class="custom-badge status-green ">Non Urgent</button>
                                </td>
                                <td class="text-end">
                                    <div class="dropdown dropdown-action">
                                        <a href="#" class="action-icon dropdown-toggle"
                            ...
                            <tr>
                                ...
                                <td>Jaundice</td>
                                <td>
                                    <button class="custom-badge status-pink">Emergency</button>
                                </td>
                                <td class="text-end">
                                    <div class="dropdown dropdown-action">
                                        <a href="#" class="action-icon dropdown-toggle"
                            ...
                            <tr>
                                ...
                                <td>Malaria</td>
                                <td>
                                    <button class="custom-badge status-gray">Out Patient</button>
                                </td>
                                <td class="text-end">
                                    <div class="dropdown dropdown-action">
                                        <a href="#" class="action-icon dropdown-toggle"
                            ...
                            <tr>
                                ...
                                <td>Typhoid</td>
                                <td>
                                    <button class="custom-badge status-orange">Non Urgent</button>
                                </td>
                                <td class="text-end">
                                    <div class="dropdown dropdown-action">
                                        <a href="#" class="action-icon dropdown-toggle"
