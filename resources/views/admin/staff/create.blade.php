...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('staff.store')}}" autocomplete="off" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col">
                                <div class="form-group select-gender">
                                    ...
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio"  name="balance_commission" checked value="balance" class="form-check-input">Balance
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio"   name="balance_commission" value="commission" class="form-check-input">Commissions
                                        </label>
                                    </div>
                                    </div>
                                    <div class="col-4">
                                    <div class="form-group local-forms" id="balance" >
                                        ...
                                        <div class="form-group local-forms" style="display:none;"  id="commission" >
